...
# make this method as a helper when solving complicated recursive problems
...
# hw... return a boolean value, whether the word is a palindrome or not
def pal(s)
...
# optional hw, similar to binary problem... if you can't get it working, abandon it, that's fine
def travel(x,y)
end
